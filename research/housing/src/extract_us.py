...
собирает вовсе; American Housing Survey собирает, но только по стране и по части
крупных агломераций; Survey of Construction — только по новостройкам и только по четырём
...
государственных данных есть. Разрешения ни у кого не просим: страница стоит
только на данных, которые можно переиспользовать без чьего-либо согласия.
