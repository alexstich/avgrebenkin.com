(function () {
  ...
  function drawMove() {
    ...
    var rows = [], notes = [], rateNote2 = false;
    ...
    if (rateNote2) {
      // Знак переворота между арендой и покупкой держится на разнице ставок, а она
      // из среза исследования. Без года эта цифра однажды станет просто неверной.
      h += "<p class=\"mnote\">Mortgage rates are the national averages the study used, mostly 2023, not today's. They drive the difference between the two answers, so put your own in the rate field above if you know better ones.</p>";
    }
